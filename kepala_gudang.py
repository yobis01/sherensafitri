...
def main():
    ...
    selected = option_menu(
        ...
        options=["Home", "Data Prediksi", "Data Barang", "Laporan", "Training Model"],  # required
        icons=["house", "graph-up-arrow", "box", "file-earmark-bar-graph", "file-earmark-check"],  # optional
